...
Public Class RptNoAll_ATM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SuratJalan.RptNoAll_ATM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pmNoOrder() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptNoAll_ATM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNoAll_ATM = New RptNoAll_ATM()
        rpt.Site = Me.Site
        Return rpt
    End Function
