...
Public Class RptSuratJalanATM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SuratJalan.RptSuratJalanATM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSuratJalanATM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSuratJalanATM = New RptSuratJalanATM()
        rpt.Site = Me.Site
        Return rpt
    End Function
