...
Public Class RptNilaiAsset
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SuratJalan.RptNilaiAsset.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNilaiAsset
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNilaiAsset = New RptNilaiAsset()
        rpt.Site = Me.Site
        Return rpt
    End Function
